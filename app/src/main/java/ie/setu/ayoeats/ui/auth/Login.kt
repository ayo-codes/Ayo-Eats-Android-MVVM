package ie.setu.ayoeats.ui.auth
...
import ie.setu.ayoeats.databinding.ActivityLoginBinding
import ie.setu.ayoeats.home.Home
...
class Login : AppCompatActivity() {
    ...
    public override fun onStart() {
        ...
        // call the setupGoogleSigninCallBack
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                when(result.resultCode){
                    RESULT_OK -> {
                        ...
                        Timber.i("Ayo-Eats Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
